...
#     fn_summary = obj.get("function")           # Nombre de la función (ej. "create_event")
#     params = obj.get("parameters", {})      # Parámetros a pasar (ej. {"summary": "Reunión", ...})

#     # Verifica que la función exista en tu mapa
#     if fn_summary not in FUNCTION_MAP:
#         print(f"Función desconocida: {fn_summary}")
#         return

#     fn = FUNCTION_MAP[fn_summary]  # Asigna la función real (ej. create_event)
...
#     try:
#         print(f"➡️ Ejecutando {fn_summary}(**{params})...")
#         resultado = fn(**params)
#         print("✅ Ejecución correcta:", resultado)
#     except Exception as e:
#         print(f"❌ Error ejecutando {fn_summary}: {e}")
